  ...
  return (
    <footer className="mt-24 border-t border-line/60 bg-surface-alt">
      <div className="w-full px-6 xl:px-10 grid gap-10 py-16 md:grid-cols-12">
        <div className="md:col-span-4">
          ...
          <p className="mt-4 max-w-sm text-sm text-muted-foreground">
            Aperion is a curated clothing brand celebrating understated luxury and timeless design. 
          ...
          <div className="mt-6 space-y-2 text-sm">
            ...
            <a href="mailto:hello@aperion.shop" className="flex items-center gap-2 text-ink-soft hover:text-terracotta"><Mail className="h-4 w-4 text-terracotta" /> hello@aperion.shop</a>
          </div>
        ...
        <div className="md:col-span-2">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li><Link to="/about" className="text-ink-soft hover:text-terracotta">About Aperion</Link></li>
      ...
      <div className="w-full px-6 xl:px-10 flex flex-col gap-2 border-t border-line/60 py-6 text-xs text-muted-foreground md:flex-row md:items-center md:justify-between">
        <div>© {new Date().getFullYear()} Aperion. All rights reserved.</div>
      </div>
    </footer>
  );
}
